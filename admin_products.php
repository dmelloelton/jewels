...
$sql = "SELECT gold_price,silver_price FROM element_price";
...
if(isset($_POST['add_product'])){
   ...
   // calculate the price based on the element type
   if($element == 'Gold'){
   ...
   if(mysqli_num_rows($select_product_name) > 0){
      ...
      $add_product_query = mysqli_query($conn, "INSERT INTO `products`(name, price, weight, description, category_id, image, category) VALUES('$name', '$total','$weight', '$desc','$category','$image','$element')") or die('query failed');
   ...
   $sql = mysqli_query($conn, "SELECT name FROM `products`") or die('query failed');
}
...
<section class="show-products">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <div class="price" id="total">Rs <?php echo $fetch_products['price']; ?>/-</div>
